...
//echo "empty";
                ...
                update_post_meta($productid, '_crowdfundingtodatepicker', $newdate);
                update_post_meta($productid, '_crowdfundingtohourdatepicker', $newhour);
                update_post_meta($productid, '_crowdfundingtominutesdatepicker', $newminutes);
            }
            $my_post = array(
                'ID' => $productid,
            ...
            update_post_meta($productid, '_crowdfundinggettargetprice', $newgoal);
            update_post_meta($productid, '_target_end_selection', $endmethod);
            // echo 1;
        }
    }
...
//        }
    ...
    public static function cf_contribution_extension_table() {
        ...
        <?php echo '<p style="display:inline-table"> ' . __('Search:', 'galaxyfunder') . '<input id="filter" type="text"/>  ' . __('Page Size:', 'galaxyfunder') . '
...
//add_action('wp_head', array('CFContributioneextension', 'test'));
?>