...
new CFShopPageAdmin();
add_action('woocommerce_update_options_crowdfunding_shoppage', array('CFShopPageAdmin', 'crowdfunding_process_shoppage_update_settings'));
add_action('init', array('CFShopPageAdmin', 'crowdfunding_shoppage_default_settings'));
add_action('woocommerce_cf_settings_tabs_crowdfunding_shoppage', array('CFShopPageAdmin', 'crowdfunding_process_shoppage_admin_settings'));
add_filter('woocommerce_cf_settings_tabs_array', array('CFShopPageAdmin', 'crowdfunding_admin_shoppage_tab'), 100);
add_action('admin_init', array('CFShopPageAdmin', 'cf_shoppage_reset_values'), 2);
add_action('admin_head', array('CFShopPageAdmin', 'show_hide_options_for_selected_styles_shop'));
