...
<option value="1" <?php selected('1', $POPoptions['bps_pop_uninstall']); ?>><?php _e('BPS Pro Upgrade Uninstall', 'bulletproof-security'); ?></option>
<option value="2" <?php selected('2', $POPoptions['bps_pop_uninstall']); ?>><?php _e('Complete BPS Plugin Uninstall', 'bulletproof-security'); ?></option>
</select><br />
